...
def parse_alert(payload):
    ...
    if event_type not in ("intrusion", "shutter", "shutter-1", "shutter-2", "panic", "test"):
        raise ValueError("event_type must be one of intrusion, shutter, shutter-1, shutter-2, panic, test")
